...
function preload() {
  fondo = loadImage("media/fondo1.png");
  barraJugador = loadImage("media/barra1.png");
  barraComputadora = loadImage("media/barra2.png");
  bola = loadImage("media/bola.png");
  sonidoRebote = loadSound("media/bounce.wav");
