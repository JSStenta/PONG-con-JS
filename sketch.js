...
class Raqueta {
    ...
    update() {
        ...
        //identifa si la raqueta es la del jugador, raqueta jugador es la de la izquierda
        if (this.x < width / 2) {
            this.y = mouseY;
        } else {
...
function preload() {
    imagenPelota = loadImage('media/bola.png');
    imagenRaqueta = loadImage('media/barra1.png');
    imagenComputadora = loadImage('media/barra2.png');
    imagenFondo = loadImage('media/fondo1.png');
    sonidoRaqueta = loadSound('media/bounce.wav');
    sonidoGol = loadSound('media/jingle_win_synth_02.wav');
}
...
function narrarPuntos() {
    ...
    let puntos = "El marcador está " + puntosJugador + " a " + puntosComputadora;
